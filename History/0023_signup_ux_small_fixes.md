...
User sign-up testing (small fixes)
...
- Moved the square/circle/name-line guides onto a separate non-interactive overlay canvas (signup.html, draw.html, plus new .canvas-wrap/#templateOverlay CSS) so they're a visual hint only and never get baked into the exported/saved PNG.
